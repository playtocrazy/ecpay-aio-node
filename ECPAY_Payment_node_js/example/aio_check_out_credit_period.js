...
let base_param = {
    MerchantTradeNo: 'f0a0d7e9fae1bb72bcas', //請帶20碼uid, ex: f0a0d7e9fae1bb72bc93
    MerchantTradeDate: '2018/08/24 11:44:30', //ex: 2017/02/13 15:45:30
    TotalAmount: '50',
    TradeDesc: '測試交易描述',
    ItemName: '測試商品等',
...
const htm = create.payment_client.aio_check_out_credit_period(period_info = period_params, parameters = base_param, invoice = inv_params);
console.log(htm);