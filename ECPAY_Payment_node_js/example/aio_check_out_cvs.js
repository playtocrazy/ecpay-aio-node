...
let base_param = {
    MerchantTradeNo: 'f0a0d7e9fae3MOpIFY', //請帶20碼uid, ex: f0a0d7e9fae1bb72bc93
...
const htm = create.payment_client.aio_check_out_cvs(cvs_info = cvs_params, parameters = base_param, invoice = inv_params, client_redirect_url = client_redirect);
console.log(htm);